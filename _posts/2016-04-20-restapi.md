...
Host명이 ims.com인 ims파트라는 Resource에 대해 예를 들면,

- `GET` [`http://ims.com/cells`](http://asdg:8081/cells)
 모든 셀 반환
- `GET` [`http://ims.com/cells/goCell`](http://asdg:8081/cells/goCell)
 고셀에 대한 정보 반환

- `POST` `http://ims.com/cells`
 새로운 셀 등록
 <form action="http://1asdg7:8081/cells" method="post">
